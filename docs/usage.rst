...
.. code-block:: bash
    ...
    $ galaxy-mk2 --help
    Usage: galaxy-mk2 [OPTIONS] COMMAND [ARGS]...
    ...
    Commands:
      serve  galaxy-mk2 CLI serve command.
    $ galaxy-mk2 serve --help
    Usage: galaxy-mk2 serve [OPTIONS]
...
.. code-block:: bash
    ...
    $ make image
    $ podman run -dit --name galaxy-mk2 -p 8000:8000 galaxy-mk2:$(cat TAG)
    f41e5fa7ffd512aea8f1aad1c12157bf1e66f961aeb707f51993e9ac343f7a4b
    $ podman ps
    CONTAINER ID  IMAGE                                 COMMAND               CREATED        STATUS            PORTS                   NAMES
    f41e5fa7ffd5  localhost/galaxy-mk2:0.1.0  /usr/bin/fastapi ...  2 seconds ago  Up 3 seconds ago  0.0.0.0:8000->8000/tcp  galaxy-mk2
    $ curl localhost:8000/api/ready
    {"status":"ok"}
...
You can implement your own web routes logic straight away in ``galaxy_mk2.controllers`` submodule. For more information please see `FastAPI documentation <https://fastapi.tiangolo.com/tutorial/>`__.
...
.. code-block:: bash
    ...
    Usage:
      ...
      clean-image      Clean galaxy-mk2 image
      install          Install galaxy-mk2 with poetry
      metrics          Run galaxy-mk2 metrics checks
      unit-test        Run galaxy-mk2 unit tests
      integration-test  Run galaxy-mk2 integration tests
      docs             Build galaxy-mk2 documentation
...
* RedisClient ``galaxy_mk2.app.utils.redis``
* AiohttpClient ``galaxy_mk2.app.utils.aiohttp_client``
...
.. code-block:: python
    ...
    from galaxy_mk2.app.utils import RedisClient
...
.. literalinclude:: ../galaxy_mk2/app/exceptions/http.py
    :language: python
...
All application configuration is available in ``galaxy_mk2.config`` submodule.
...
.. literalinclude:: ../galaxy_mk2/config/gunicorn.py
    :language: python

Routes
~~~~~~

Endpoints are defined in ``galaxy_mk2.app.router`` submodule. Just simply import your controller and include it to FastAPI router:

.. literalinclude:: ../galaxy_mk2/app/router.py
    :language: python
