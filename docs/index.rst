...
.. code-block:: bash
    ...
    fastapi-mvc available under: http://galaxy-mk2.192.168.49.2.nip.io/
...
.. code-block:: bash
    ...
    ...
    Kubernetes cluster ready
    FastAPI available under: http://galaxy-mk2.192.168.49.2.nip.io/
    You can delete dev-env by issuing: make clean
    vagrant@ubuntu-focal:/syncd$ kubectl get all -n galaxy-mk2
    NAME                                                     READY   STATUS    RESTARTS   AGE
    pod/galaxy-mk2-7f4dd8dc7f-p2kr7                1/1     Running   0          55s
    ...
    vagrant@ubuntu-focal:/syncd$ curl http://galaxy-mk2.192.168.49.2.nip.io/api/ready
    {"status":"ok"}
Documentation
-------------
